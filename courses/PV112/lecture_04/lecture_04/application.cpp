...
Application::Application(int initial_width, int initial_height, std::vector<std::string> arguments)
    ...
    glNamedBufferStorage(diamond_positions_vbo, sizeof(diamond_positions), diamond_positions, 0);
    glCreateBuffers(1, &diamond_colors_vbo);
    glNamedBufferStorage(diamond_colors_vbo, sizeof(diamond_colors), diamond_colors, 0);
    ...
    glNamedBufferStorage(square_vbo, sizeof(square_data), square_data, 0);
    ...
    glNamedBufferStorage(triangle_vbo, sizeof(triangle_vertices), triangle_vertices, 0);
    ...
    glNamedBufferStorage(diamond_indices_vbo, sizeof(diamond_indices), diamond_indices, 0);
    glNamedBufferStorage(diamond_positions_indexed_vbo, sizeof(diamond_positions_indexed), diamond_positions_indexed, 0);
    glNamedBufferStorage(diamond_colors_indexed_vbo, sizeof(diamond_colors_indexed), diamond_colors_indexed, 0);
